<template>
  <div>
    <transition-group name="list" tag="b-list-group">
      <b-list-group-item v-for="todoItem, index in this.storedTodoItems" v-bind:key="todoItem.item" class="d-flex justify-content-between shadow-sm p-2 mb-1 bg-white rounded">
        <span>
